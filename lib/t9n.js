...
T9n = {
  ...
  get: function(label, markIfMissing, args, lang){
    args = args || {};
    this.dep.depend();
    ...
    if (this.maps[lang] !== undefined && this.maps[lang][label]){
      ret = this.maps[lang][label];
...
t9n = function (label, markIfMissing, args, lang){
  return T9n.get(label, markIfMissing, args, lang);
}
